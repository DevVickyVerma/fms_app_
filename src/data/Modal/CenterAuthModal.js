                        ...
                        <DialogContentText>
                            <>
                                {isLoading ? (
                                    ...
                                    <>
                                        <img src={require("../../assets/images/dashboard/authModalImage.png")} alt="MyChartImage" className="all-center-flex object-fit-contain w-40 h-40 m-auto " />
                                        <div className=" text-center mt-2">
                                            <strong className="fs-19">
                                                Add Extra Security With Two Factor Authentication
                                            </strong>
                                        </div>
                                        <p className=" text-center">Help protect your account, even if someone gets hold your password</p>
