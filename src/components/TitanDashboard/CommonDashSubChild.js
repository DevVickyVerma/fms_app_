            ...
            <div className="page-header ">
                <div>
                    <h1 className="page-title">
                        {/* {getSiteStats?.data?.site_name || "CEsssssO Dashboard Site details"} (
                    ...
                    <Breadcrumb className="breadcrumb">
                        ...
                        <Breadcrumb.Item
                            className="breadcrumb-item"
                            linkAs={Link}
                            linkProps={{ to: "/titandashboard-details" }}
                        >
                            Titan Details
                        </Breadcrumb.Item>
                        <Breadcrumb.Item
...
export default withApi(CommonDashSubChild);
