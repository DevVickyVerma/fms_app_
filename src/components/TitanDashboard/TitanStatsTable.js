        ...
        >
          <div className="d-flex align-items-center h-100 ">
            <div className="ms-2 mt-0 mt-sm-2 d-block">
              <OverlayTrigger
                placement="top"
                overlay={<Tooltip>Wet Stock Value</Tooltip>}
              >
              ...
              <OverlayTrigger
                placement="top"
                overlay={<Tooltip>YTD Value</Tooltip>}
              >
                <p>
                  <span className="l-sign">£</span>{" "}
          ...
          <div className="d-flex align-items-center h-100 ">
            <div className="ms-2 mt-0 mt-sm-2 d-block">
              <OverlayTrigger
                placement="top"
                overlay={<Tooltip>Wet Stock Volume</Tooltip>}
              >
                <h4 className="mb-0 fs-15 fw-semibold ">
              ...
              <OverlayTrigger
                placement="top"
                overlay={<Tooltip>YTD Volume</Tooltip>}
              >
                <p>
                  <span className="l-sign">ℓ</span>{" "}
        ...
        >
          <div className="d-flex align-items-center h-100 ">
            <div className="ms-2 mt-0 mt-sm-2 d-block">
              <OverlayTrigger
                placement="top"
                overlay={<Tooltip>Delivery Loss Value</Tooltip>}
              >
                <h4 className="mb-0 fs-15 fw-semibold ">
                  <span className="l-sign">£</span>{" "}
          ...
          <div className="d-flex align-items-center h-100 ">
            <div className="ms-2 mt-0 mt-sm-2 d-block">
              <OverlayTrigger
                placement="top"
                overlay={<Tooltip>Delivery Loss Volume</Tooltip>}
              >
                <h4 className="mb-0 fs-15 fw-semibold ">
                  <span className="l-sign">ℓ</span>{" "}
        ...
        >
          <div className="d-flex align-items-center h-100 ">
            <div className="ms-2 mt-0 mt-sm-2 d-block">
              <OverlayTrigger
                placement="top"
                overlay={<Tooltip>Unkonwn Loss Value</Tooltip>}
              >
                <h4 className="mb-0 fs-15 fw-semibold ">
                  <span className="l-sign">£</span>{" "}
          ...
          <div className="d-flex align-items-center h-100 ">
            <div className="ms-2 mt-0 mt-sm-2 d-block">
              <OverlayTrigger
                placement="top"
                overlay={<Tooltip>Unkonwn Loss Volume</Tooltip>}
              >
                <h4 className="mb-0 fs-15 fw-semibold ">
                  <span className="l-sign">ℓ</span>{" "}
        ...
        >
          <div className="d-flex align-items-center h-100 ">
            <div className="ms-2 mt-0 mt-sm-2 d-block">
              <OverlayTrigger
                placement="top"
                overlay={<Tooltip>Closing Stock Value</Tooltip>}
              >
                <h4 className="mb-0 fs-15 fw-semibold ">
                  <span className="l-sign">£</span>{" "}
          ...
          <div className="d-flex align-items-center h-100 ">
            <div className="ms-2 mt-0 mt-sm-2 d-block">
              <OverlayTrigger
                placement="top"
                overlay={<Tooltip>Closing Stock Volume</Tooltip>}
              >
                <h4 className="mb-0 fs-15 fw-semibold ">
                  <span className="l-sign">ℓ</span>{" "}
        ...
        <Col lg={12}>
          {title ? (
            <Card>
              ...
              <Card.Body>
                {data?.length > 0 ? <TableComponent /> : <NoDataComponent />}
              </Card.Body>
            </Card>
          ) : data?.length > 0 ? (
            <TableComponent />
