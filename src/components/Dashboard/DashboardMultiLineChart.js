...
const DashboardMultiLineChart = ({ LinechartValues, LinechartOption }) => {
  ...
  const revenueChart = {
    ...
    //   {
    //     name: 'Fuel Volume',
    //     data: [12000, 13000, 12500, 15000, 13500, 14500, 15000, 15500, 16000, 16500, 17000, 17500], // Dummy data
    //   },
    //   {
    //     name: 'Gross Margin',
...
//     data: dataset.data.map(Number),
//     fill: {
//       type: 'solid', // Use solid fills for area
//       // colors: [colorArray[index]], // Specify the color for the area
//       colors: "#1B55E2", // Specify the color for the area
//     },
//   }));
...
//     chart: {
//       height: 500,
//       // type: "area", // Ensure chart type is 'area'
//       fontFamily: "Nunito, sans-serif",
//       zoom: {
//         enabled: false,
//       },
...
//     },
//     fill: {
//       type: 'solid', // Use 'solid' type for area chart
//       opacity: 1,
//     },
//   };
