                ...
                <div className="m-4 textend">
                  ...
                  <CeoFilterBadge
                    filters={{
                      ...
                      company_name:
                        formik?.values?.selectedCompanyDetails?.company_name,
                      site_name: formik?.values?.selectedSiteDetails?.site_name ? formik?.values?.selectedSiteDetails?.site_name : filterData?.sites[0]?.site_name, // Pass "yes" if it has a value, "no" otherwise
                    }}
                    showResetBtn={false}
                  />
                </div>
