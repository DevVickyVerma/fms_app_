...
import { Baroptions, StockData, StockDetail } from "../../../Utils/commonFunctions/CommonData";
  ...
  return (
    <>
      ...
      >
        <div className="card">
          <div
            className={`card-header text-center SidebarSearchheader  ${isMobile ? "mobile-sidebar-header" : ""}`}
          >
