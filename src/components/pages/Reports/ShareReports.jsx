                                            ...
                                            <div className="form-group">
                                                ...
                                                <div>
                                                    <MultiSelect
                                                        ...
                                                        options={formik?.values?.allReports?.map((item) => ({
                                                            value: item?.id,
                                                            label: item?.name,
                                                            emails: item?.emails
                                                        })) || []}
                                                ...
                                                {formik.touched.service && typeof formik.errors.service === 'string' && (
                                            ...
                                            <>
                                                ...
                                                <Card.Body className="share-report-body">
                                                    {formik?.values?.service?.map((report) => (
                                                        <div key={report?.value} style={{ marginBottom: '20px' }}>
                                                            <h4 className="bold">{report?.label}</h4>
                                                            <ul>
                                                                {report?.emails?.map((email, index) => (
                                                                    <Badge className="me-2 p-2" key={index}><i className="ph ph-envelope-simple"></i> {email}</Badge>
                                                                ))}
                                                            </ul>
                                                        </div>
                                                    ))}
