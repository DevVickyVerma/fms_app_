...
const AddHoliday = (props) => {
    ...
    const handleSubmit1 = async (values) => {
        ...
        try {
            ...
            const postDataUrl = "payroll/holiday/add";
    ...
    useEffect(() => {
        if (isPermissionsSet) {
            const isAddPermissionAvailable =
                permissionsArray?.includes("holiday-create");
            ...
            <>
                <div>
                    <div className="page-header">
                        <div>
                            <h1 className="page-title">Add Holiday</h1>
                    ...
                    <Row>
                        <Col lg={12} xl={12} md={12} sm={12}>
                            <Card>
                                <Card.Header>
                                    <Card.Title as="h3">Add Holiday</Card.Title>
                                </Card.Header>
                                <Formik
                                    initialValues={{
                                        name: "",
...
export default withApi(AddHoliday);
