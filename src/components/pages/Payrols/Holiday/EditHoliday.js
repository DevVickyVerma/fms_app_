...
const EditHoliday = (props) => {
    ...
    const FetchRoleList = async () => {
        try {
            const response = await getData(`/payroll/holiday/detail/${id}`);
    ...
    const handleSubmit = async (values) => {
        try {
            ...
            const postDataUrl = "/payroll/holiday/update";
            const navigatePath = `/holiday-list/`;
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            status: Yup.string().required("Holiday Status is required"),
        }),
            ...
            <>
                <div>
                    <div className="page-header">
                        <div>
                            <h1 className="page-title">Edit Holidays</h1>
                    ...
                    <Row>
                        <Col lg={12} xl={12} md={12} sm={12}>
                            <Card>
                                <Card.Header>
                                    <Card.Title as="h3">Edit Holidays</Card.Title>
                                </Card.Header>
                                            ...
                                            <Col lg={6} md={6}>
                                                <div className="form-group">
                                                    <label
                                                        ...
                                                        className="form-label mt-4"
                                                    >
                                                        Holiday Status <span className="text-danger">*</span>
                                                    </label>
                                                    <select
...
export default withApi(EditHoliday);
