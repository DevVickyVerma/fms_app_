...
const EditAddition = (props) => {
    ...
    const FetchRoleList = async () => {
        try {
            const response = await getData(`/payroll/addition/detail/${id}`);
    ...
    const handleSubmit = async (values) => {
        try {
            ...
            const postDataUrl = "/payroll/holidays/update";
            const navigatePath = `/addition-list/`;
                ...
                <div>
                    ...
                    <Row>
                        <Col lg={12} xl={12} md={12} sm={12}>
                            <Card>
                                <Card.Header>
                                    <Card.Title as="h3">Edit Addition</Card.Title>
                                </Card.Header>
                                            ...
                                            <Col lg={6} md={6}>
                                                <div className="form-group">
                                                    <label
                                                        ...
                                                        htmlFor="name"
                                                    >
                                                        Addition Name <span className="text-danger">*</span>
                                                    </label>
                                                    <input
                                                        type="text"
                                                        autoComplete="off"
...
export default withApi(EditAddition);
