...
const AddAddition = (props) => {
    ...
    const handleSubmit1 = async (values) => {
        ...
        try {
            ...
            const postDataUrl = "payroll/addition/add";
    ...
    useEffect(() => {
        if (isPermissionsSet) {
            const isAddPermissionAvailable =
                permissionsArray?.includes("addition-create");
            ...
            <>
                <div>
                    <div className="page-header">
                        <div>
                            <h1 className="page-title">Add Addition</h1>
                    ...
                    <Row>
                        <Col lg={12} xl={12} md={12} sm={12}>
                            <Card>
                                <Card.Header>
                                    <Card.Title as="h3">Add Addition</Card.Title>
                                </Card.Header>
                                <Formik
                                    initialValues={{
                                        name: "",
                                    ...
                                    validationSchema={Yup.object({
                                        name: Yup.string()
                                            .required(" Addition Name is required"),


                                        type_status: Yup.string().required(
                                            "Addition Status is required"
                                        ),
                                    })}
                                    onSubmit={(values) => {
...
export default withApi(AddAddition);
