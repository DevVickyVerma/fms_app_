...
const AddDesignation = (props) => {
    ...
    const handleSubmit1 = async (values) => {
        ...
        try {
            ...
            const postDataUrl = "payroll/designation/add";
    ...
    useEffect(() => {
        if (isPermissionsSet) {
            const isAddPermissionAvailable =
                permissionsArray?.includes("designation-create");
                ...
                <div>
                    ...
                    <Row>
                        <Col lg={12} xl={12} md={12} sm={12}>
                            <Card>
                                <Card.Header>
                                    <Card.Title as="h3">Add Designation</Card.Title>
                                </Card.Header>
                                <Formik
                                    initialValues={{
                                        name: "",
...
export default withApi(AddDesignation);
