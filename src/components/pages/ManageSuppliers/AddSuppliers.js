                      ...
                      <Row>
                        <Col lg={6} md={12}>
                          <FormGroup>
                            ...
                            <Field
                              ...
                              className={`input101 ${errors.supplier_name && touched.supplier_name
                                ? "is-invalid"
                                : ""
                                }`}
                              id="supplier_name"
                        ...
                        <Col lg={6} md={12}>
                          <FormGroup>
                            ...
                            <Field
                              type="text"
                              className={`input101 ${errors.supplier_code && touched.supplier_code
                                ? "is-invalid"
                                : ""
                                }`}
                              id="supplier_code"
                      ...
                      <Row>
                        <Col lg={6} md={12}>
                          <FormGroup>
                            ...
                            <Field
                              as="select"
                              className={`input101 ${errors.supplier_status &&
