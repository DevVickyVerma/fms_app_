...
import { EVOBOSOptions } from "../../../Utils/commonFunctions/commonFunction";
...
export default function AddSite(props) {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      bank_ref: Yup.string().required("Bank Reference Number is required"),
                ...
                <div className="card-body">
                  <form onSubmit={formik.handleSubmit}>
                    <Row>
                      ...
                      <Col lg={4} md={6}>
                        <div className="form-group">
                          <label className="form-label mt-4" htmlFor="e_code">
                            Site Id
                          </label>
                          <input
                            id="e_code"
                            ...
                            type="text"
                            autoComplete="off"
                            className={`input101  ${formik.errors.e_code && formik.touched.e_code
                              ? "is-invalid"
                              : ""
                              }`}
                            placeholder="Site Id"
                          ...
                          />
                          {formik.errors.e_code && formik.touched.e_code && (
                            <div className="invalid-feedback">
                        ...
                        <>
                          <Col lg={4} md={6}>
                            <div className="form-group">
                              ...
                              <select
                                className={`input101 ${formik.errors.manual_upload &&
