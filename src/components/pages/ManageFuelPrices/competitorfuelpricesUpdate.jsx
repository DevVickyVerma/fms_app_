...
const competitorfuelpricesUpdate = ({ data, postData, handleFormSubmit, accordionSiteID }) => {
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            {formik.values?.head_array?.map((item) => (
                                                <th key={item?.id} className='middy-table-head'>{item}</th>
                                            ))}
                                        </tr>
                                    </thead>
                                                ...
                                                <tr>
                                                    <td className='middayModal-td'>
                                                        <div className="">
                                                            ...
                                                            />
                                                            <ErrorMessage name={`fuels[${rowIndex}][0].date`} component="div" className="text-danger" />
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td className='middayModal-td time-input-fuel-sell'>
                                                        ...
                                                        <>
                                                            <InputTime
                                                                label="Time"
                                                                value={lsitingformik?.values?.fuels?.[rowIndex]?.[0]?.time}
                                                                onChange={(newTime) => {
                                                                    if (row?.[0]?.is_editable) {
                                                                        lsitingformik.setFieldValue(`fuels[${rowIndex}][0].time`, newTime);
                                                                    }
                                                                }}
                                                        ...
                                                        <td key={item.id} className='middayModal-td'>
                                                            <div className="">
                                                                <Field
                                                                    ...
                                                                    step="0.010"
                                                                />
                                                                <ErrorMessage name={`fuels[${rowIndex}][${itemIndex}].price`} component="div" className="text-danger" />
                                                            </div>
                                                        </td>
                                                    ))}
                                                </tr>
