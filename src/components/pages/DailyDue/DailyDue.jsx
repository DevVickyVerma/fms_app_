...
const DailyDue = ({ isLoading, getData, postData }) => {
  ...
  const validationSchemaForCustomInput = Yup.object({
    start_month: Yup.date().required("Date is required"),
  });
    ...
    dues: Yup.array().of(
      Yup.object({
        ...
        operator_pay: Yup.number()
          ...
          .min(0, "Value must be zero or greater"),
        adj_operator_pay: Yup.number()
          .required("Adjustment For Operator is required")
          .min(0, "Value must be zero or greater"),
        owner_pay: Yup.number()
          .required("Payment by Owner is required")
          .min(0, "Value must be zero or greater"),
        adj_owner_pay: Yup.number()
          .required("Adjustment For Owner is required")
          .min(0, "Value must be zero or greater"),
        detail: Yup.string().required("Detail is required"),
      })
    ),
    owner_balance_carry: Yup.number()
      .required("Balance Carry Forward From Owner")
      .min(0, "Value must be zero or greater"),
    operator_balance_carry: Yup.number()
      .required("Balance Carry Forward From Operator")
      .min(0, "Value must be zero or greater"),
  });
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      values?.dues?.forEach((item, index) => {
        ...
        formData.append(`adj_operator_pay[${index}]`, item?.adj_operator_pay);
        formData.append(`adj_owner_pay[${index}]`, item?.adj_owner_pay);
        formData.append(`invoice[${index}]`, item?.invoice);
      });
        ...
        <div className="page-header d-flex">
          <div>
            <h1 className="page-title">
              {" "}
              Daily Dues ({formik?.values?.site_name})
            </h1>
                      ...
                      <Row>
                        <Col lg={6}>
                          <FormikInput
                            formik={formik}
                            type="number"
                            label="Balance Carry Forward From Operator(£)"
                            name="operator_balance_carry"
                          />
                        </Col>
                        <Col lg={6}>
                          <FormikInput
                            formik={formik}
                            type="number"
                            label="Balance Carry Forward From Owner(£)"
                            name="owner_balance_carry"
                          />
                        </Col>
                      </Row>
                        ...
                        <Row key={item?.id || index}>
                          <Col lg={3}>
                            <div className="form-group mt-4">
                              <label htmlFor={`dues[${index}].e_date`}>
                              ...
                              <input
                                ...
                                value={
                                  formik?.values?.dues?.[index]?.e_date || ""
                                } // Bind the input value to Formik
                              ...
                              {formik.touched?.dues?.[index]?.e_date &&
                                formik.errors.dues?.[index]?.e_date && (
                          ...
                          <Col lg={3}>
                            <div className="form-group mt-4">
                              <label htmlFor={`dues[${index}].invoice`}>
                                Invoice Claim
                              ...
                              {formik.touched?.dues?.[index]?.invoice &&
                                formik.errors.dues?.[index]?.invoice && (
                                  <div className="text-danger">
                                    {formik.errors.dues[index].invoice}
                                  </div>
                                )}
                          ...
                          <Col lg={3}>
                            <div className="form-group mt-4">
                              <label htmlFor={`dues[${index}].operator_pay`}>
                                Payment By Operator
                                <span className="text-danger">*</span>
                              </label>
                              <input
                                ...
                                value={
                                  formik.values.dues[index].operator_pay || "0"
                                } // Bind the input value to Formik
                                onChange={(e) =>
                                  formik.setFieldValue(
                                    e.target.name,
                          ...
                          <Col lg={3}>
                            <div className="form-group mt-4">
                              <label
                                htmlFor={`dues[${index}].adj_operator_pay`}
                              >
                                Adjustment For Operator
                                <span className="text-danger">*</span>
                              </label>
                              <input
                                type="number"
                                name={`dues[${index}].adj_operator_pay`}
                                value={
                                  formik.values.dues[index].adj_operator_pay ||
                                  "0"
                                } // Bind the input value to Formik
                                onChange={(e) =>
                                  formik.setFieldValue(
                              ...
                              />
                              {formik?.touched?.dues &&
                                formik.errors?.dues?.[index]
                                  ?.adj_operator_pay && (
                                  <div className="text-danger">
                                    {formik.errors.dues[index].adj_operator_pay}
                                  </div>
                                )}
                            </div>
                          </Col>
                          ...
                          <Col lg={3}>
                            <div className="form-group mt-4">
                              <label htmlFor={`dues[${index}].owner_pay`}>
                                Payment By Owner
                                <span className="text-danger">*</span>
                              </label>
                              <input
                                ...
                                value={
                                  formik.values.dues[index].owner_pay || "0"
                                } // Bind the input value to Formik
                                onChange={(e) =>
                                  formik.setFieldValue(
                                    e.target.name,
                          ...
                          <Col lg={3}>
                            <div className="form-group mt-4">
                              <label htmlFor={`dues[${index}].adj_owner_pay`}>
                                Adjustment For Owner
                                <span className="text-danger">*</span>
                              </label>
                              <input
                                type="number"
                                name={`dues[${index}].adj_owner_pay`}
                                value={
                                  formik.values.dues[index].adj_owner_pay || "0"
                                } // Bind the input value to Formik
                                onChange={(e) =>
                                  formik.setFieldValue(
                                    e.target.name,
                              ...
                              />
                              {formik?.touched?.dues &&
                                formik.errors?.dues?.[index]?.adj_owner_pay && (
                                  <div className="text-danger">
                                    {formik.errors.dues[index].adj_owner_pay}
                                  </div>
                                )}
                          ...
                          <Col lg={3}>
                            <div className="form-group mt-4">
                              <label htmlFor={`dues[${index}].detail`}>
