                    ...
                    <form onSubmit={formik.handleSubmit}>
                        <Card.Body>
                            <Row>
                                ...
                                {/* {showReportMonthInput && (
                                    <Col lg={6}>
                                        <FormikSelect
                                            formik={formik}
                                            name="report_month"
                                            label="report_month"
                                            options={formik?.values?.reportmonths?.map((item) => ({ id: item?.id, name: item?.display }))}
                                            className="form-input"
                                            isRequired={showReportMonthInputValidation}
