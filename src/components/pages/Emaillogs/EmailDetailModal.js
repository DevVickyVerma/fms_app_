        ...
        <div className="offcanvas-body">
          <div style={containerStyle}>
            <div style={{ marginBottom: "10px" }}>
              <span style={boldTitleStyle}>Subject:</span> <br></br>
              <span>{selectedRowId?.raw_data?.subject}</span>
              <br></br>
            </div>
            <div style={{ marginBottom: "10px" }}>
              <span style={boldTitleStyle}>Text:</span> <br></br>
              <span style={{ marginBottom: "10px" }}>
                {selectedRowId?.raw_data?.text}
              </span>
            </div>
            <div style={{ marginBottom: "10px" }}>
              <span style={boldTitleStyle}>To Email:</span> <br></br>
              <span style={{ marginBottom: "10px" }}>
            ...
            <div style={{ marginBottom: "10px" }}>
              <span style={boldTitleStyle}>Type:</span> <br></br>
